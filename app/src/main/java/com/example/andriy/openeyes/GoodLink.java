...
public class GoodLink extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_good_link);
    ...
    public void showRampInHouse(View view) {
        Intent intent = new Intent(getBaseContext(), GetRamp.class);
        startActivity(intent);
    }
    public void showRamp(View view){
        Intent intent=new Intent(getBaseContext(), Ramp.class);
        startActivity(intent);
    }
